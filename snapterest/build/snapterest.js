		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'col-md-8' },
					React.createElement(Collection, { tweets: this.state.collectionTweets, onRemoveTweetFromCollection: this.removeTweetFromCollection, onRemoveAllTweetFromCollection: this.removeAllTweetFromCollection })
				)
			)
		);
	}
	...
	render: function () {
		...
		if (numberOfTweetsInCollection > 0) {
			...
			return React.createElement(
				'div',
				null,
				React.createElement(CollectionControls, { numberOfTweetsInCollection: numberOfTweetsInCollection, htmlMarkup: htmlMarkup, onRemoveAllTweetFromCollection: removeAllTweetFromCollection }),
...
var CollectionControls = React.createClass({
	...
	render: function () {
		...
		return React.createElement(
			...
			React.createElement(Button, { label: 'Empty Collection', handleClick: this.props.onRemoveAllTweetFromCollection }),
...
var StreamTweet = React.createClass({
	...
	componentWillReceiveProps: function (nextProps) {
		console.log('[Snapterest] StreamTweet: 5. Running componentWillReceiveProps()');
...
},{"./Tweet.react":223,"react":163}],225:[function(require,module,exports){
